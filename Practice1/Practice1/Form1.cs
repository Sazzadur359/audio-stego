...
namespace Practice1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string cover_audio_file = @"D:\Project-wave\Audio\Practice1\audio\StegoP1.wav";
                ...
                waveCoverAudio.WriteFile(@"D:\Project-wave\Audio\Practice1\audio\output.wav");
        ...
        {
            string stego_audio = @"D:\Project-wave\Audio\Practice1\audio\output.wav";
